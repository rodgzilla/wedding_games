...
A dinosaur with Selki's head rides a rocket off the launch pad, and its exhaust billows into an **inverted** Pythagoras tree — hanging from the top of the screen and spreading downward — whose every square is a cut-out of Selki's head. Roughly: countdown to 1.4s, ignition and screen shake to 2.0s, the rocket climbs while the plume blooms level by level to 6.8s, rocket exits in a spark burst to 7.4s, the plume thrashes and settles to 9.2s, fade to the recap at 10s.
